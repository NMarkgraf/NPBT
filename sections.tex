...
\setbeamertemplate{title page}
{
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=south east,xshift=1cm,yshift=2cm] at (current page.south east){%
          \begin{tabular}{b{0.6\myPaperWidth}}
...
%         \vspace*{-1em}%
  ...
  \vspace*{-2.4em}\hspace*{\dimexpr0.9\paperwidth+\logoxshift\relax}%
  \includegraphics[%
    width=\logowidth%0.99cm%
  ]{% 
    \logoimage%
  }
...
\setbeamertemplate{section page}
{
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south east,xshift=-1cm,yshift=1.5cm] at (current page.south east){%
        \begin{minipage}[b][0.25\myPaperHeight][t]{0.5\myPaperWidth}
          \begin{FlushRight}
